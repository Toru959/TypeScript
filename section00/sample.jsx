...
const element11 = <img src="myImage.jpg" alt="" />;
...
'JSXでのフラグメントの使用'
'フラグメントは<React.Fragment>タグを使って明示的に表現することができます。次の例では、h1とh2要素がフラグメント内にまとめられています。'
const element12 = (
  <React.Fragment>
    <h1>Hello!</h1>
...
// 描画結果: <h1>Hello!</h1><h2>Good to see you here.</h2>
'いずれの形式でも、フラグメントを使うことでh1とh2要素は同一階層に配置され、それらをラップする余計なHTML要素を追加せずにレンダリングされます。フラグメントは、Reactアプリケーションのレンダリングパフォーマンスを持続的に向上させるツールとなります。'