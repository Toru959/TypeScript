...
'object, Object, {}の違い'
'TypeScriptではオブジェクトの型注釈をする時、プロパティの型まで指定するのが一般的です'
let obj2: { a: number, b: number};

'そういった一般的な型注釈とは異なり、プロパティの型を指定せず、ざっくりオブジェクトであることを型注釈する方法もあります。object型やObject型、{}を使用するものです'
let a2: object;
let b2: Object;
let c: {};
'これらはどれもオブジェクトのかたの値ならどんなモノでも代入可能です'
const a3: object = {};
const b3: Object = {};
const c3: {} = {};

'{}型'
'{}型は、プロパティを持たないオブジェクトを表す型です。プロパティを持ちうる値ならなんでもだいにゅうできます。この点はObject型と似ていて、null, undefinedをあらゆる型を代入できます。'
let a4: {};
a4 = {};
a4 = 1;
a4 = true;
